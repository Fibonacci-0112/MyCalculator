...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        builder.Services.AddSingleton<ColoradoWithholdingCalculator>(sp =>
        {
            ...
            return new ColoradoWithholdingCalculator(json, sp.GetRequiredService<IStateSchemaProvider>());
        });
        builder.Services.AddSingleton<ConnecticutWithholdingCalculator>(sp =>
        {
            ...
            return new ConnecticutWithholdingCalculator(json, sp.GetRequiredService<IStateSchemaProvider>());
        });

        builder.Services.AddSingleton(new FicaCalculator());

        // State UI schemas (declarative JSON) — see Data/Schemas/<state>.json
        builder.Services.AddSingleton<IStateSchemaProvider>(sp =>
        {
            ...
            foreach (var state in Enum.GetValues<UsState>())
            {
                ...
                try
                {
                    using var stream = FileSystem.OpenAppPackageFileAsync($"schemas/{name}.json").Result;
                    using var reader = new StreamReader(stream);
                    map[state] = reader.ReadToEnd();
                }
        ...
        // Data-driven state calculator registry (validation + calculation; UI schemas come from IStateSchemaProvider)
        builder.Services.AddSingleton<StateCalculatorRegistry>(sp =>
        {
            var registry = new StateCalculatorRegistry();
            var schemaProvider = sp.GetRequiredService<IStateSchemaProvider>();

            // Alabama — unique filing statuses, dependents, federal withholding
            registry.Register(new AlabamaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new CaliforniaWithholdingCalculator(caCalc, schemaProvider));
            ...
            registry.Register(new DelawareWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new DistrictOfColumbiaWithholdingCalculator(schemaProvider));

            // Georgia — flat 5.19% with G-4 filing statuses, dependents,
            // standard deduction, and additional allowances (HB 111 / 2026
            // Employer's Tax Guide)
            registry.Register(new GeorgiaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new HawaiiWithholdingCalculator(schemaProvider));

            // Idaho — flat 5.3% with ID W-4 filing-status standard deduction
            // and $3,300 per pre-2020 allowance (Idaho HB 521 / EPB00006)
            registry.Register(new IdahoWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new KansasWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new LouisianaWithholdingCalculator(schemaProvider));
            ...
            // Withholding Tables
            registry.Register(new MaineWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new MarylandWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new MassachusettsWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new MinnesotaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new MississippiWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new MissouriWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new MontanaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new NebraskaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new NewJerseyWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new NewMexicoWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new NewYorkWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new NorthCarolinaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new NorthDakotaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new OregonWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new RhodeIslandWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new SouthCarolinaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new UtahWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new VermontWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new VirginiaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new WestVirginiaWithholdingCalculator(schemaProvider));
            ...
            registry.Register(new WisconsinWithholdingCalculator(schemaProvider));

            // Oklahoma — OW-2 percentage method
            var okCalc = sp.GetRequiredService<OklahomaOw2PercentageCalculator>();
            registry.Register(new OklahomaWithholdingCalculator(okCalc, schemaProvider));
            ...
            foreach (var (state, config) in StateTaxConfigs2026.Configs)
                registry.Register(new PercentageMethodWithholdingAdapter(state, config, schemaProvider));
